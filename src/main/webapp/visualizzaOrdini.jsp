    ...
    <div class="card m-auto">
      ...
      <table class="table table-bordered">
        ...
        <tr>
          ...
          <td><a class="btn btn-primary" href="./VisualizzaDettaglioOrdineController?id=<%=ordine.getId()%>" style="background-color: #800000; color:white">Visualizza dettagli</a></td>
        </tr>
        <%} %>
