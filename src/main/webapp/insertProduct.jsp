...
<%
  Collection<AutoreBean> autoriCollection = (Collection<AutoreBean>) request.getAttribute("autori");
  ...
  <div class="row flex-nowrap">
    ...
    <div class="col py-3">
      <div class="card m-auto">
        ...
        <div class="card-body">
          <form action="<%=response.encodeURL("InserisciProdottoController")%>" method="POST">
            <div class="mb-3">
              <label for="isbn" class="form-label">ISBN (massimo 13 cifre)</label>
              <input type="number" class="form-control" id="isbn" name="isbn" maxlength="13" required>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <select class="form-control" id="autore" name="codiceAutore" required>
                <option value="">Seleziona un autore</option>
                <% for (AutoreBean autore : autoriCollection) { %>
                <option value="<%= autore.getCodice()%>"><%= autore.getNome() %> <%=autore.getCognome()%></option>
                <% } %>
              </select>
            </div>
            <div class="mb-3">
